...
function setStats(stats) {
  ...
  $('<div class="playername"><div class="serviceicon '+stats.service+'">&nbsp;</div>'+stats.playername+'</div>').appendTo(statsDiv);
...
function bbDecode(data) {
  return data
    ...
    .replace(/:\\/g,'<span class="smile smile003"></span>')
    ...
    .replace(/:[I|i]/g,'<span class="smile smile014"></span>')
    .replace(/:[J|j]/g,'<span class="smile smile015"></span>')
    ...
    .replace(/:[s|S]/g,'<span class="smile smile027"></span>')
    .replace(/=[V|v]/g,'<span class="smile smile028"></span>')
...
$('#sidepanelhide').click(function(){ if ($('#sidepanel').width() < 30) { $('#sidepanel').animate({width:'380px'},400).removeClass('hide'); } else { $('#sidepanel').animate({width:'20px'},400).addClass('hide'); } });
