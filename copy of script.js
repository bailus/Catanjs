...
function autoMoveRobber(x,y) {
  ...
  console('info','The robber was moved!');
}
...
function connect(gameid) {
	socket = io.connect('http://localhost:1337'+gameid);
	socket.on('connection',function(data){
	  console('info','Connected to game '+gameid);
	});
...
function lobby() {
	var lobbysocket = io.connect('http://localhost:1337/lobby');
	lobbysocket.on('connection',function(data){
		console('info','Connected to the lobby.');
	});
